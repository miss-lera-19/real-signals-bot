...
def start(update: Update, context: CallbackContext):
    kb = [["📝 Змінити маржу", "📉 Змінити плече"], ["📊 Ціни зараз"]]
    reply_markup = ReplyKeyboardMarkup(kb, resize_keyboard=True)
    update.message.reply_text("✅ Бот активний. Обери опцію:", reply_markup=reply_markup)
...
def check_market():
    while True:
        ...
        requests.post(f"https://api.telegram.org/bot{BOT_TOKEN}/sendMessage",
                      data={"chat_id": CHAT_ID, "text": "⏳ Пошук можливостей на ринку..."})
        time.sleep(600)
